...
{
    buttonList.push_back(new GuiButtonMenu(0,m_width/2, m_height/2 - 100, 100, 50, "Jouer"));
    buttonList.push_back(new GuiButtonMenu(1,m_width/2, m_height/2 - 100 + 30, 100, 50, "Options"));
    buttonList.push_back(new GuiButtonMenu(2,m_width/2, m_height/2 - 100 + 60, 100, 50, "Quitter"));
    GuiScreen::initGui();
}
